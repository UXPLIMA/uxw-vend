        ...
        return (
            <div className="w-full">
                <input
                    ...
                    className={cn(
                        "flex h-10 w-full rounded-lg border border-border bg-background pl-4 pr-4 py-2 text-sm text-foreground placeholder:text-muted-foreground transition-colors duration-200",
