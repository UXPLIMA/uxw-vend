...
export default function FooterSettingsPage() {
    ...
    return (
        <SettingsForm
            ...
            fields={[
                { key: "footer_about_text", label: t("footer_aboutText"), type: "textarea", placeholder: t("footer_aboutTextPlaceholder") },
                ...
                { key: "footer_copyright", label: t("footer_copyright"), placeholder: t("footer_copyrightPlaceholder") },
            ]}
        />
    );
}
